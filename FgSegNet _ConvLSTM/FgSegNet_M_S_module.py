...
from keras.layers import Activation, Input, Dropout, BatchNormalization, SpatialDropout2D, ConvLSTM2D
...
class FgSegNet_M_S_module(object):
    ...
    def __init__(self, lr, reg, img_shape, scene, vgg_weights_path, inputShape, seq_length = 5):
        self.lr = lr
        self.reg = reg
        self.img_shape = img_shape
        self.scene = scene
        self.vgg_weights_path = vgg_weights_path
        self.input_shape = tuple(np.append(seq_length, np.array(inputShape)))
        
    def VGG16(self, x): 
        
        x = ConvLSTM2D(64, (3, 3), activation='relu', dropout=0.5, padding='same', input_shape = self.input_shape,
                       name='block1_conv1', data_format='channels_last')(x)
        
#        x = ConvLSTM2D(64, (3, 3), activation='relu', padding='same', name='block1_conv2')(x)
#        x = MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool')(x)
#    
#        # Block 2
#        x = ConvLSTM2D(128, (3, 3), activation='relu', padding='same', name='block2_conv1')(x)
#        x = ConvLSTM2D(128, (3, 3), activation='relu', padding='same', name='block2_conv2')(x)
#        x = MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool')(x)
#    
#        # Block 3
#        x = ConvLSTM2D(256, (3, 3), activation='relu', padding='same', name='block3_conv1')(x)
#        x = ConvLSTM2D(256, (3, 3), activation='relu', padding='same', name='block3_conv2')(x)
#        x = ConvLSTM2D(256, (3, 3), activation='relu', padding='same', name='block3_conv3')(x)
#    
#        # Block 4
#        x = ConvLSTM2D(512, (3, 3), activation='relu', padding='same', name='block4_conv1')(x)
#        x = Dropout(0.5, name='dr1')(x)
#        x = ConvLSTM2D(512, (3, 3), activation='relu', padding='same', name='block4_conv2')(x)
#        x = Dropout(0.5, name='dr2')(x)
#        x = ConvLSTM2D(512, (3, 3), activation='relu', padding='same', name='block4_conv3')(x)
#        x = Dropout(0.5, name='dr3')(x)
    ...
    def transposedConv(self, x):
        ...
        # block 9
        x = Conv2DTranspose(5, (1, 1), padding='same', name='block9_conv1')(x)
